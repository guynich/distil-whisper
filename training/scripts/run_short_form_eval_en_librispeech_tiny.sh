...
# Adapted for Librispeech clean test with OpenAI Whisper Tiny in float32.
# Compare https://huggingface.co/openai/whisper-tiny#evaluation WER 7.5%.
...
# WER 8.23607 % is higher than without the language option.
#   --language "en" \
